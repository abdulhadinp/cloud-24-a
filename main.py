...
# DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://cloud24a:Abdul@123@cloud-24-adb.postgres.database.azure.com:5432/queries")
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://cloud24a:Abdul-123@cloud-db-abdulhadi.postgres.database.azure.com:5432/postgres")
